...
import RenderImages from "../../../components/user/renderPostInProflie/RenderImages";
...
import ParentComment from "../../../components/user/comments/ParentComment";
import RenderCurrentPost from "../../../components/user/renderPostInProflie/RenderCurrentPost";
// import PhotoGallery from "./PhotoGallery";
export default function GroupBlogList({
  onFetchData,
  groupBlogs,
  currentUserId,
}) {
  ...
  const [grouPostList, setGroupPostList] = useState([]);
  ...
  const handleDeletePost = async (postId) => {
    try {
      await baseUrl.delete(`/user/posts/${postId}`); // API xóa bài viết
      message.success("Bài viết đã được xóa!");

      // Cập nhật danh sách bài viết
      setGroupPostList((prevPosts) =>
          ...
          <>
            ...
            <div className="flex justify-center">
              <div
                ...
                key={post.id}
                className="bg-white w-[70%]  px-4 py-1 h-auto rounded-lg shadow-md dark:bg-neutral-800 border border-gray-300 dark:border-neutral-600 hover:cursor-pointer"
              >
                {/* User Info */}
                <div className="mt-3 flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-gray-200">
                      {post?.group.title} {/* Tên đầy đủ của người đăng */}
                    </p>
                    {/* ID người đăng */}
                ...
                <div className="mb-3 mt-3 flex justify-between text-sm text-gray-500 ">
                  ...
                  <div className="flex space-x-6 text-[15px]">
                    <p>{post.commentCount || 0} bình luận</p>
